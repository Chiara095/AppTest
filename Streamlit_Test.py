...
with col1:
    ...
    st.image('C:\\Users\\berret_c\\Documents\\GitHub\\dsml_project\\Berre.png', width=150)
...
with col3:
    ...
    st.image('C:\\Users\\berret_c\\Documents\\GitHub\\dsml_project\\Vaient.png', width=150)
